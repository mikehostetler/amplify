...
amplify.subscribe( "request.ajax.preprocess", function( defnSettings, settings, ajaxSettings ) {
	...
	if ( typeof data === "string" || ( data && Object.prototype.toString.call(data) !== "[object Object]" ) ) {
		// In the case of a string or an array, we exit quickly without altering the data
		return;
	}
	...
	if ( !mappedKeys.length ) {
		return; // Nothing was mapped – leave the original data alone
	}
